...
public class ProduitService {
    ...
    public void mettreAJourStockAuto(int idProduit, Integer variationQuantite, BigDecimal variationPoids)
            throws SQLException {
        ...
        if (produit.getPoid() != null) {
            if (variationPoids == null) {
                throw new IllegalArgumentException("Variation de poids requise pour un produit géré en vrac.");
            }

            BigDecimal nouveauPoids = produit.getPoid().add(variationPoids);
            if (nouveauPoids.compareTo(BigDecimal.ZERO) < 0) {
                throw new IllegalArgumentException("Le stock en poids ne peut pas être négatif.");
            }
        ...
        if (variationQuantite == null) {
            throw new IllegalArgumentException("Variation de quantité requise pour un produit unitaire.");
        }
